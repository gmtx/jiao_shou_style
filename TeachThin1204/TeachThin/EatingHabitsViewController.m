...
@interface EatingHabitsViewController ()

@end

@implementation EatingHabitsViewController
...
- (void)viewDidLoad
{
    ...
    _Arr =  [[NSArray alloc]initWithObjects:@"柑橘类水果",@"鸡蛋",@"鱼",@"贝壳",@"碘",@" 牛奶",@"其他", nil];
    [self setlayout];
...
-(void)sureBtnClick
{
    [[NSNotificationCenter defaultCenter]postNotificationName:@"allergy" object:_postArr];
