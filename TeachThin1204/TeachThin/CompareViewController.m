...
{
    NSString *urlstr = URL_JiaohuanfenData;
    NSDictionary *pragma = [NSDictionary dictionaryWithObjectsAndKeys:_Foodname,@"p",nil];
    JSHttpRequest *request = [[JSHttpRequest alloc]init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath;
{
    ...
    if(cell==nil){
        ...
        titleLable = [[UILabel alloc]initWithFrame:CGRectMake(20, 10, 110, 30)];
        ...
        detaillable = [[UILabel alloc]initWithFrame:CGRectMake(130,20, VIEW_WEIGHT-120, 30)];
