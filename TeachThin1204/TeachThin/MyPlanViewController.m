...
-(void)sureBtnClick:(id)sender
{
    ...
    NSString * lunch = [NSString stringWithFormat:@"%@",tf3.text];
     ...
     NSDictionary * data = [NSDictionary dictionaryWithObjectsAndKeys:breakfast,@"breakfast",breakfastadd,@"breakfastadd",lunch,@"lunch",lunchadd,@"lunchadd",dinner,@"dinner",dinneradd,@"dinneradd", nil];
     NSString * uid = @"1";
     NSString * date = @"2014-12-1";
    
    NSDictionary * postDict = [NSDictionary dictionaryWithObjectsAndKeys:uid,@"uid",date,@"date",data,@"data",nil];
    NSLog(@"%@",postDict);
