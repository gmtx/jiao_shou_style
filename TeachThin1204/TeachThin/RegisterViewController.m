...
//     if([self checkTel:tf1.text]&&[tf2.text length]==4)
//     {
//         [self submit];
//     }else
//     {
//         UIAlertView * alert = [[UIAlertView alloc]initWithTitle:@"提示" message:@"请先完善验证信息" delegate:nil cancelButtonTitle:@"知道了" otherButtonTitles:nil, nil];
//         [alert show];
//     }
