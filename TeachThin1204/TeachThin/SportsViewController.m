...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc]initWithTitle:@"搜索" style:UIBarButtonItemStyleBordered target:self action:@selector(SearchBtnPress)];
...
-(void)SetMenuView
{
    ...
    [MenuView setListDataArr:@[@"有氧运动",@"无氧运动",@"瑜伽",@"体操",@"舞蹈"]];
